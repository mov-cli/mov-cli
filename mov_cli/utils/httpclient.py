...
default_header = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                                "Chrome/80.0.3987.163 "
                                "Safari/537.36",
                "Accept-Language":"en-GB,en;q=0.5"}

class HttpClient:
    def __init__(self,timeout=10.0,headers=default_header):
